...
def check_window():
    global checkfile
    checkwindow = Tk()
    checkwindow.configure(bg='black')
...
def checkfolder_window():
    ...
    checkfolderwindow.configure(bg='black')
...
def remove_window():
    global removefolder
    removewindow = Tk()
    removewindow.configure(bg='black')
...
Label(root, text="File Manager", bg = "black", fg = "white").grid(row=5, column=2)

Button(root, text="Open a File", command=open_window, height = 10, width = 30, bg = "#89c3fa").grid(row=7, column=1)

Button(root, text="Copy a File", command=copy_window, height = 10, width = 30, bg = "#89c3fa").grid(row=19, column=13)

Button(root, text="Delete a File", command=delete_window, height = 10, width = 30, bg = "#89c3fa").grid(row=25, column=1)

Button(root, text="List all Files in Directory", command=list_window, height = 10, width = 30, bg = "#89c3fa").grid(row=31, column=1)

Button(root, text="Check a File", command=check_window, height = 10, width = 30, bg = "#89c3fa").grid(row=13, column=1)

Button(root, text="Rename a File", command=rename_window, height = 10, width = 30, bg = "#89c3fa").grid(row=7, column=13)

Button(root, text="Check Folder", command=checkfolder_window, height = 10, width = 30, bg = "#89c3fa").grid(row=19, column=1)

Button(root, text="Move a File", command=rename_window, height = 10, width = 30, bg = "#89c3fa").grid(row=13, column=13)

Button(root, text="Make a Folder", command=make_window, height = 10, width = 30, bg = "#89c3fa").grid(row=25, column=13)

Button(root, text="Remove a Folder", command=remove_window, height = 10, width = 30, bg = "#89c3fa").grid(row=31, column=13)
